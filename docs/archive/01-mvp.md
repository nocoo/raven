...
│   │   └── package.json
│   │
│   └── dashboard/                  # Next.js + basalt 设计系统, port 7023
│       ├── src/
│       │   ├── app/
...
|---|---|---|
| Proxy dev | 开发 | 7024 |
| Dashboard dev | 开发 | 7023 |
| Proxy API E2E | L3 测试 | 17024 |
| Dashboard API E2E | L3 测试 (Route Handlers 转发验证) | 17023 |
