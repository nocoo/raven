...
export function sanitizePayload(payload: AnthropicMessagesPayload): AnthropicMessagesPayload {
  ...
  // Strip thinking blocks from assistant messages. Copilot cannot verify
  // the `signature` field generated by a previous API call, so including
  // them causes "Invalid `signature` in `thinking` block" errors.
