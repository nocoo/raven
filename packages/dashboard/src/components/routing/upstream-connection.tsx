...
export function UpstreamConnection({ upstream, value, onChange }: { upstream: ProviderPublic | null; value: UpstreamDraft; onChange: (value: UpstreamDraft) => void }) {
  ...
  return <div className="space-y-3">
    ...
    <div className="grid items-start gap-4 @min-[38rem]/editor:grid-cols-[minmax(0,1fr)_minmax(0,2fr)]">
    ...
    <Collapsible asChild><LayerCard>
      ...
      <CollapsibleContent unstyled><LayerCard.Body className="space-y-4"><div className="grid gap-4 @min-[26rem]/editor:grid-cols-2">
