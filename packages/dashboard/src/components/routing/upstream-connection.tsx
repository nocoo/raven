...
export function UpstreamConnection({ upstream, value, onChange }: { upstream: ProviderPublic | null; value: UpstreamDraft; onChange: (value: UpstreamDraft) => void }) {
  if (upstream?.kind === "copilot") return <LayerCard className="space-y-3">
  ...
  return <LayerCard className="space-y-4">
    ...
    <Collapsible defaultOpen={value.auth_style !== null || value.use_socks5 !== null || value.supports_reasoning}>
