...
export function UpstreamCatalog({ upstream, manual, onManualChange, busy, dirty, refresh, test, testModel, onTestModelChange }: {
  ...
  return <div className="space-y-5">
    ...
    <section className="space-y-3" aria-label="Model catalog">
      ...
      <LayerCard.Well className="max-h-48 space-y-1 overflow-y-auto p-2">
    ...
    <section className="space-y-3 border-t border-basalt-border pt-4" aria-label="Test connection">
